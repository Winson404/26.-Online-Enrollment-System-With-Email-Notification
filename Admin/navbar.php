    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link"><i class="fa-solid fa-user-group"></i><p>&nbsp; Student lists<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
               <a href="users.php" class="nav-link"><i class="fa-solid fa-user-group"></i><p>&nbsp;&nbsp;Pending students</p></a>
              </li>
             <li class="nav-item">
              <a href="enrolled_students.php" class="nav-link"><i class="fa-solid fa-user-group"></i><p>&nbsp;&nbsp;Enrolled students</p></a>
             </li>
            </ul>
          </li>
          <li class="nav-header text-secondary" style="margin-bottom: -10px;">MANAGEMENT</li>
          <li class="nav-item">
            <a href="teacher.php" class="nav-link"><i class="fa-solid fa-chalkboard-user"></i><p>&nbsp;&nbsp;Manage Teacher</p></a>
          </li>
          <li class="nav-item">
            <a href="section.php" class="nav-link"><i class="fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp;Manage Section</p></a>
          </li>
          <li class="nav-item">
            <a href="subject.php" class="nav-link"><i class="fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp;Manage Subject</p></a>
          </li>
