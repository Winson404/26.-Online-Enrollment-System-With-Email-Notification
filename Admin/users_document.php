<title>BMS | Student's document</title>
<?php 
    include 'navbar.php';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Student's document</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Student's document</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="col-md-12">
            <div class="card">      
              <div class="card-body p-5">
                  <div class="row">
                      <img src="../images-document/<?php echo $row['document']; ?>" class="img-fluid d-block m-auto">
                  </div>
                  <hr>
                  <div class="float-right">
                    <a href="users_view.php?user_Id=<?php echo $user_Id; ?>" class="btn bg-secondary btn-sm"><i class="fa-solid fa-backward"></i> Back</a>
                    <button type="button" class="btn bg-info btn-sm" data-toggle="modal" data-target="#updateDocument<?php echo $user_Id; ?>"><i class="fa-solid fa-pen"></i> Edit document</button>
                  </div>
              </div>
      ...
      <!-- UPDATE DOCUMENT -->
    <div class="modal fade" id="updateDocument<?php echo $user_Id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="row">
                <div class="col-12">
                    <div class="form-group">
                      <span class="text-dark"><b>Student's documents</b></span>
