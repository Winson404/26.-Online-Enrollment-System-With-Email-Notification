<title>Online Enrollment System | Student info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                          ...
                          <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                  <span class="text-dark"><b>Enrollment type</b></span>
                                  <select class="form-control" name="enrollmentType" required>
                                    <option selected disabled value="">Select enrollment type</option>
                                    <option value="Old/Regular">Old/Regular</option>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Nationality</b></span>
                              <input type="text" class="form-control"  placeholder="Nationality" name="nationality" required value="Filipino">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                          <a class="h5 text-primary"><b>Student address</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                          <a class="h5 text-primary"><b>Guardian information</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Guardian name</b></span>
                              <input type="text" class="form-control" placeholder="Guardian name" name="guardianName" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-text">+63</div>
                                <input type="tel" class="form-control" pattern="[7-9]{1}[0-9]{9}" id="contact" name="guardianContact" placeholder = "9123456789" maxlength="10">
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                          <a class="h5 text-primary"><b>School information to enroll</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Name of School</b></span>
                              <input type="text" class="form-control"  placeholder="Name of School" name="schoolName">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>School Address</b></span>
                              <input type="text" class="form-control"  placeholder="School Address" name="schoolAddress">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Student photo (Optional)</b></span>
                              <div class="input-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Student scanned documents</b></span>
                              <div class="input-group">
                                <div class="custom-file">
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="process_update.php" method="POST" enctype="multipart/form-data">
              <input type="hidden" class="form-control"  placeholder="First name" name="user_Id" required value="<?php echo $user_Id; ?>">
              <div class="card">
                <div class="card-body">
                    <div class="row">
                          ...
                          <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="enrollmentType" required>
                                    <option selected disabled value="">Select enrollment type</option>
                                    <option value="Old/Regular" <?php if($row['enrollmentType'] == 'Old/Regular') { echo 'selected'; } ?>>Old/Regular</option>
                                    <option value="New"         <?php if($row['enrollmentType'] == 'New') { echo 'selected'; } ?>>New</option>
                                    <option value="Transferee"  <?php if($row['enrollmentType'] == 'Transferee') { echo 'selected'; } ?>>Transferee</option>
                                    <option value="Returnee"    <?php if($row['enrollmentType'] == 'Returnee') { echo 'selected'; } ?>>Returnee</option>
                                  </select>
                                </div>
                            </div>
                          </div>
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                            <span class="text-dark"><b>Nationality</b></span>
                            <input type="text" class="form-control" placeholder="Nationality" name="nationality" required value="<?php echo $row['nationality']; ?>">
                          </div>
                      </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Guardian name</b></span>
                              <input type="text" class="form-control" placeholder="Guardian name" name="guardianName" required value="<?php echo $row['guardianName']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-text">+63</div>
                                <input type="tel" class="form-control" pattern="[7-9]{1}[0-9]{9}" id="contact" name="guardianContact" placeholder = "9123456789" maxlength="10" value="<?php echo $row['guardianContact']; ?>">
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Name of School</b></span>
                              <input type="text" class="form-control"  placeholder="Name of School" name="schoolName" value="<?php echo $row['schoolName']; ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>School Address</b></span>
                              <input type="text" class="form-control"  placeholder="School Address" name="schoolAddress" value="<?php echo $row['schoolAddress']; ?>">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                      ...
                      <div class="col-lg-12 mt-3 mb-2">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Student scanned documents (Optional)</b></span>
                              <div class="input-group">
                                <div class="custom-file">
