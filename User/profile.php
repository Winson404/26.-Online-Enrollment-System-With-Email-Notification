<title>Online Enrollment System | Admin profile</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="enrollmentInfo.php">Home</a></li>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center"><?php echo $row['enrollmentType']; ?></p>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="viewprofile">
                      ...
                      <div class="form-group row">
                        <label for="First name" class="col-sm-2 col-form-label">Nationality</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="First name" placeholder="Religion" value="<?php echo $row['nationality']; ?>" readonly>
                        </div>
                      </div>              
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <a  class="col-sm-12 text-primary text-bold">Guardian information</a>
                      </div>
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">Guardian name</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="House No." name="guardianName" required value="<?php echo $row['guardianName']; ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">Guardian contact</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-text">+63</div>
                            <input type="tel" class="form-control" pattern="[7-9]{1}[0-9]{9}" id="Contact number" name="guardianContact" placeholder = "9123456789" required maxlength="10" value="<?php echo $row['contact']; ?>" readonly>
                          </div>
                        </div>
                      </div>

                      <div class="form-group row">
                        <a  class="col-sm-12 text-primary text-bold">School information</a>
                      </div>
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">Name of School</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="House No." name="schoolName" required value="<?php echo $row['schoolName']; ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">School address</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="Street name" name="schoolAddress" required value="<?php echo $row['schoolAddress']; ?>" readonly>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" id="updateprofile">
                      ...
                      <div class="form-group row">
                        <label for="Contact number" class="col-sm-2 col-form-label">Nationality</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="House No." name="guardianName" required value="<?php echo $row['guardianName']; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-text">+63</div>
                            <input type="tel" class="form-control" pattern="[7-9]{1}[0-9]{9}" id="Contact number" name="guardianContact" placeholder = "9123456789" required maxlength="10" value="<?php echo $row['contact']; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="House No." name="schoolName" required value="<?php echo $row['schoolName']; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            <input type="text" class="form-control"  placeholder="Street name" name="schoolAddress" required value="<?php echo $row['schoolAddress']; ?>">
                          </div>
                        </div>
                      </div>
