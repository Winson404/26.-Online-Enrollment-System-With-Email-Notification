  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="enrollmentInfo.php" class="nav-link">Home</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
...
?>
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-header bg-primary">
            ...
            <p>
              ...
              <small><?php echo $row['enrollmentType']; ?></small>
            </p>
          </li>
          <!-- Menu Body -->
          <li class="user-body">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="enrollmentInfo.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="enrollmentInfo.php" class="nav-link bg-gradient-primary active"><i class="fa-solid fa-registered"></i><p>&nbsp;&nbsp; Enrollment info</p></a>
          </li>
